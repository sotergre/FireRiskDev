/******************************************************************************************
fmodel_l100hr_1000hr_nas_v2_IMERG.c
...
previous day's moisture content in % (signed 16bit)
output number of days since litter moisture value (signed 16bit)
...
output is:
moisture content is average moisture content (signed 16bit)
...
sprintf(filename, "%s/AMZEX/IMERG/%d/daysum/ppt_IMERG30m_early_%d%.3d_dur_AMZ.bin" , data_dir, prevyear, prevyear,prevjday);
