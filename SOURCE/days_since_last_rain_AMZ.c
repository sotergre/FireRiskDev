...
02/08/20008
 ...
 Inputs:
	...
	Previous Day's DSLR since last last file in 8 bit binary.
	Daily rainfall summatinons in mm file type is 16 bit signed binary.
	The file size is 444 rows by 555 columns. The units
 ...
 Output:
	...
	<previous Day's DSLR file> <current day rainfall summation> <output DSLR> <threshold mm>
...
int main( int argc, char **argv )
{
   ...
   /* total number of pixels (rows*cols=444*555) */
   unsigned int npixels = 246420;
