...
/**************************************************************************
 interpolate_MOD07_temporal_nas_16day.c
 Jen Small
 ed Karyn Tabor
 last update 10/16/2015
  ...
  This program uses temporal interpolation of the past 16 days to fill in flagged
  ...
  average value of 16 previous daily images.
...
***********************************************************************/
   ...
   /*stores dates of previous 16 days*/
   int date_array[16][2];
