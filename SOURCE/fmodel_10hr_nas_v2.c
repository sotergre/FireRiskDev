...
int delta_t;
unsigned char *rain_1, *rain_2,*rain_1_ptr, *rain_2_ptr;
...
sprintf(filename, "%s/AMZEX/3B42RT/%d/15_hrdur/ppt_3b42rt_%d%.3d_dur_AMZEX_p1.bin" , data_dir, prevyear, prevyear,prevjday);
...
sprintf(filename, "%s/AMZEX/3B42RT/%d/09_hrdur/ppt_3b42rt_%d%.3d_dur_AMZEX_p2.bin" , data_dir, prevyear, prevyear,prevjday);
...
float exchange(unsigned char up_rain, signed short int m_init, signed short int m_eq, int hrs)
{
