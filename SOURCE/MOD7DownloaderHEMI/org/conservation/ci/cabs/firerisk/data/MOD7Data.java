                ...
                if (!next.startsWith(COMMENT_PREFIX))
                {
                    ...
                    if (metaData[DAY_NIGHT_INDEX].trim().equalsIgnoreCase(DAY_VALUE))
                    {
                        ...
                        if ((
                           ...
                           (
                                (gRingLatitude1 >= -28.0 && gRingLatitude1 <= 13.0) ||
                                (gRingLatitude2 >= -28.0 && gRingLatitude2 <= 13.0) ||
                                (gRingLatitude3 >= -28.0 && gRingLatitude3 <= 13.0) ||
                                (gRingLatitude4 >= -28.0 && gRingLatitude4 <= 13.0)
                           ))
                        {
