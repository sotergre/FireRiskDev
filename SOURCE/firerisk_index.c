...
input is unsigned 8bit file and output is unsigned 8bit file.  
...
unsigned char *input_lm0100, *input_lm0100_ptr, *input_lm1000, *input_lm1000_ptr, *output, *output_ptr;
...
Memory Allocation
*************************************************************/
allocate_binary(total_pixels, "uchar", (void *)(&input_lm0100));
allocate_binary(total_pixels, "uchar", (void *)(&input_lm1000));
...
if(read_binary(total_pixels, input_lm0100_filename, "uchar", (void *)(&input_lm0100))==-1)
{
...
if(read_binary(total_pixels, input_lm1000_filename, "uchar", (void *)(&input_lm1000))==-1)
{
...
for(i=0; i<total_pixels;i++)
    {
		...
		if(*input_lm0100_ptr+*input_lm1000_ptr == 0)
			...
			*output_ptr = (unsigned char)((*input_lm0100_ptr+*input_lm1000_ptr)/2);
			}
